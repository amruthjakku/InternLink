    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {/* Tech Lead Option */}
          <div 
            onClick={() => onRoleSelect('Tech Lead')}
          ...
          >
            <div className="text-center">
              ...
              <h4 className="text-xl font-semibold text-gray-900 mb-2">I'm a Tech Lead</h4>
          ...
          {/* AI Developer Intern Option */}
          <div 
            onClick={() => onRoleSelect('AI Developer Intern')}
          ...
          >
            <div className="text-center">
              ...
              <h4 className="text-xl font-semibold text-gray-900 mb-2">I'm an AI Developer Intern</h4>
              <p className="text-gray-600 text-sm mb-4">
